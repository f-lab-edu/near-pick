...
import com.nearpick.domain.user.dto.CheckEmailRequest
import com.nearpick.domain.user.dto.CheckEmailVerificationRequest
...
class UserController(
    ...
    fun updateUser(
        ...
        if (!request.email.isNullOrBlank()) {
            verificationService.isVerifyEmail(VerificationType.UPDATE_USER_EMAIL, request.email)
        }
