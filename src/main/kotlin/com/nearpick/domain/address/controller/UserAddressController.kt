...
import com.nearpick.domain.address.service.UserAddressService
...
class UserAddressController(
    ...
    fun list(
        ...
        return ResponseEntity.ok(
            Response.success(userAddressService.findAllUserAddressByUserId(userPrincipal.getUser().id))
        )
    }
    ...
    fun delete(
        ...
        userAddressService.deleteUserAddress(id, userPrincipal.getUser().id)
